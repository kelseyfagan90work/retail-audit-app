...
// question's note and photos, so callers building an email body can reuse
// this instead of re-fetching the same data.
export async function generateAuditPdf(auditId, admin = createAdminClient(), { hideAuditor = false } = {}) {
